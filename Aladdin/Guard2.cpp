...
void Guard2::UpdateCollision(DWORD dt)
{
	...
	if (isCollideAladdin)
	{
		if (Aladdin::GetInstance()->GetAttacking())
		{
			...
			{
				enemiesDeadEffect->SetPos(this->GetPositionX() + GUARD2_SPRITE_WIDTH / 2, this->GetPositionY() + GUARD2_SPRITE_HEIGHT / 2, false);
