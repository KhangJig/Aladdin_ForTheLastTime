...
#pragma region STAND
	...
	Sprite * skeleton_stand_18 = new Sprite(skeleton->GetTexture(), listSprite[18], TEXTURE_TRANS_COLOR);
	anim->AddFrame(skeleton_stand_18);
	Sprite * skeleton_stand_19 = new Sprite(skeleton->GetTexture(), listSprite[19], TEXTURE_TRANS_COLOR);
